...
exports.forwardContactUsEmail = function(message, emailAddress) {
    ...
    let transporter = nodemailer.createTransport({
        ...
        auth: {
            user: 'blueribbonhrsystem@gmail.com',
    ...
    let mailOptions = {
        from: '"Hotel Blue Ribbon Automated Services" <blueribbonhrsystem@gmail.com>',
        to: emailAddress,
        ...
        '<br/><br/>Please do your best to assist the customer.<br/><br/>Sincerely, <br/>Hotel Blue Ribbon Automated Services<br/>(555) 415-5104<br/>' +
