            ...
            case 'carePackage': {
                ...
                setTimeout(() => {
                    if (this.state.carePackage) {
                        this.setState({ carePackageCost: '$' + (this.props.pricing.carePackageCost.toFixed(2) * this.props.itinerary.numNights) });
            ...
            case 'lateCheckout': {
                ...
                setTimeout(() => {
                    if (this.state.lateCheckout) {
                        this.setState({ lateCheckoutCost: '$' + (this.props.pricing.lateCheckoutCost.toFixed(2) * this.props.itinerary.numNights) });
            ...
            case 'shuttleRide': {
                ...
                setTimeout(() => {
                    if (this.state.shuttleRide) {
                        this.setState({ shuttleRideCost: '$' + (this.props.pricing.shuttleRideCost * this.props.itinerary.numNights).toFixed(2) });
            ...
            case 'luggageHold': {
                ...
                setTimeout(() => {
                    if (this.state.luggageHold) {
                        ...
                        this.setState({ luggageHoldCost: '$' + (this.props.pricing.luggageHoldCost.toFixed(2) * this.props.itinerary.numNights) });
                    } else {
        ...
        return (
            <div className="container">
                ...
                <h3 style={{ textAlign: 'center' }}>
                    We hope you enjoy your stay at Hotel West Inn, Wichita! Please ensure the
